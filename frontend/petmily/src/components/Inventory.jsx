...
function Inventory({ inventoryItems }) {
  ...
  return (
    <div className="sticky top-[7.3rem] rounded-11xl bg-white min-w-[350px] basis-1/4 h-fit overflow-hidden shrink-0 flex flex-col py-4 px-0 box-border items-start justify-start gap-[12px] text-lg">
